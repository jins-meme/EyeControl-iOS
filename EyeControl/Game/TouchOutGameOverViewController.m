//
//  TouchOutGameOverViewController.m
//  EyeControl
//
...
@interface TouchOutGameOverViewController () {
    CheckView *checkView;
...
@implementation TouchOutGameOverViewController
...
- (void)gameReplay {
    [self.touchOutGameViewController clearEnemy];
    [self dismissViewControllerAnimated:NO completion:^{
        [self.touchOutGameViewController restart];
    }];
}
